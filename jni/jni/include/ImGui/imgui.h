...
namespace ImGui
{
    ...
    IMGUI_API bool          WIDGETS_EXPERT_Tab(const char* icon,const char* name, bool boolean);
    IMGUI_API bool          WIDGETS_EXPERT_Subtab(const char* name, bool boolean);
	...
	IMGUI_API bool          WIDGETS_EXPERT_Open(const char* ico, const ImVec2& size = ImVec2(0, 0), bool rotation = false);   // button
    IMGUI_API bool          WIDGETS_EXPERT_Close(const char* ico,const char* name, const ImVec2& size = ImVec2(0, 0), bool rotation = false);   // button
    ...
    IMGUI_API bool          𝗜𝗠𝗚𝗨𝗜_𝗚𝗢𝗗(const char* label, bool* v);
	...
	IMGUI_API bool          LoadTextureFromFile(const char* filename, uint* out_texture, int* out_width, int* out_height); 
    // Debug Utilities
